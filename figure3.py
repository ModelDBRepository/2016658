...
delay = 100.0
max_amplitude = 0.33 #33 #0.00055 # 0.02
reduction = 0 #0.222 #0.5 # between 0 and 1
recovery = 200 # ramp duration
pre_duration = 1000.0 #1000.0
post_duration = 8500.0
min_amplitude = 0
...
ax3.plot(tVec, qkv1_record)
ax3.set_ylabel('Q')
#ax3.set_ylim(0.2,0.25)
#ax3.set_xlim(200,250)
ax4 = fig.add_subplot(5, 1, 4)
ax4.plot(tVec, qtau_record)
ax4.set_ylabel('Qtau')
#ax4.set_xlim(200,250)
ax4.set_xlabel('Time (ms)')
#ax5 = fig.add_subplot(7, 1, 5)
#ax5.plot(tVec, hkv1_record)
#ax5.set_ylabel('hkv1')
#ax6 = fig.add_subplot(7, 1, 6)
#ax6.plot(tVec, mkv1_record)
#ax6.set_ylabel('mkv1')
...
plt.savefig("elliptical_bursting.png")
plt.show()
